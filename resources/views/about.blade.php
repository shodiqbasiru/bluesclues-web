...
<div class="container-fluid page-about p-5" id="p-about">
    <div class="container-lg hero">
        <img src="{{ url('/assets/img/about/hero_about_1.png') }}" alt="">
        <img src="{{ url('/assets/img/about/hero_about_2.png') }}" class="position" alt="">
        <img src="{{ url('/assets/img/about/hero_about_3.png') }}" alt="">
        <img src="{{ url('/assets/img/about/hero_about_4.png') }}" class="position" alt="">
    </div>
    <div class="container-lg content text-center">
        <img class="blues-logo" src="{{ url('/assets/img/logo_2.png') }}" alt="">
        <table>
            <tr>  
