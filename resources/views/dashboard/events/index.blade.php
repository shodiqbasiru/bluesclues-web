            ...
            <tr>
                ...
                <td class="align-middle" style="max-width: 400px;">
                    ...
                    <a href="{{ $item->maps }}" target="_blank">
                        <i class="fas fa-location-dot mx-3" style="color: red;"></i>
                    </a>
                    @endif
                </td>
                ...
                <td class="align-middle">
                    <a href="/admin/dashboard/events/{{ $item->slug }}" class="btn-action-dashboard btn-sm me-2"><i
                            class="fas fa-eye"></i></a>

                    <a href="/admin/dashboard/events/{{ $item->slug }}/edit" class="btn-action-dashboard btn-sm me-2"><i
