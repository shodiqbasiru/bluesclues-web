    ...
    <form method="POST" action="{{ route('merchandise.update', $merchandise->slug) }}" enctype="multipart/form-data">
        ...
        <div class="form-group my-4">
            ...
            <select name="category_id" id="category_id"
                ...
                <option value="{{ $category->id }}" {{ old('category', $merchandise->category_id) == $category->id ?
                    'selected' : '' }}>
                    {{ $category->name }}
                </option>
                @endforeach
        ...
        <div class="form-group my-4">
            ...
            <select name="is_available" id="is_available"
                ...
                <option value="1" {{ old('is_available', $merchandise->is_available)==1 ? 'selected' : '' }}>Available</option>
                <option value="0" {{ old('is_available', $merchandise->is_available)==0 ? 'selected' : '' }}>Sold Out</option>
            </select>
