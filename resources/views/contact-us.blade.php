    ...
    <form action="{{ route('message.store') }}" class="row g-3" method="POST">
        ...
        <div class="col-12">
            ...
            <input type="text" name="subject" class="form-control {{ $errors->has('subject') ? ' is-invalid' : '' }}" id="subject" value="{{ old('subject') }}"
                placeholder="Please enter the subject of the message" required>
        ...
        <div class="col-12">
            ...
            <input type="text" name="whatsapp" class="form-control {{ $errors->has('whatsapp') ? ' is-invalid' : '' }}" id="whatsapp" value="{{ old('whatsapp') }}"
                placeholder="Please enter your whatsapp number" required>
        ...
        <div class="col-12">
            ...
            <textarea name="message_content" class="form-control {{ $errors->has('message') ? ' is-invalid' : '' }}" id="message_content"
                placeholder="Please enter your message" rows="3" required>{{ old('message_content') }}</textarea>
        </div>
